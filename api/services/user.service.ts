...
export default class UserService {
    ...
    public async create(client:any){
        ...
        try {
            ...
            subject: 'Register',
            text: 'Welcome',
            html: `<strong>Your account is added successfully. <a href=${ process.env.PROD_ENV=='prod'?'https://applications-custom.vercel.app/login':'http://localhost:3000/login'}> Confirm your email address</a> Thank you for choosing us for a good history of your applications</strong>`,
            }
            try {
